...
class ScriptRunner(QObject, QRunnable):
    ...
    def run(self):
        ...
        try:
            ...
            full_command_list = [self.script_path] + self.args
...
"background-color: rgb(255,255,255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>For information on how workflows work <a href=\"https://github.com/JC-Price/Chalf_public/blob/main/Demos%20and%20Documentation/workflows_tutorial.md\"><span style=\" text-decoration: underline; color:#0000ff;\">see this tutorial</span></a>.</p></body></html>", None))
        self.label_3.setOpenExternalLinks(True)
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Input Files", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>CHalf takes an input of csv files with quantified and identified peptides. Formatting matters for the analysis. See this <a href=\"https://github.com/JC-Price/Chalf_public/blob/main/Demos%20and%20Documentation/formatting_guide.md\"><span style=\" text-decoration: underline; color:#0000ff;\">formatting guide</span></a> before starting.</p></body></html>", None))
    ...
    def start_run(self):
        ...
        script_to_run = "core/CHalf_v4_3_core.exe"
        script_args = []
...
if __name__ == "__main__":
    ...
    try:
        ...
        if getattr(sys, 'frozen', False) and hasattr(sys, '_MEIPASS'):
            ...
            icon_path = os.path.join(sys._MEIPASS, 'images', 'CHalf Protein Logo.png')
        else:
            # If running from source, assume 'images' is relative to the script's directory
            script_dir = os.path.dirname(os.path.abspath(__file__))
            icon_path = os.path.join(script_dir, 'images', 'CHalf Protein Logo.png')
        
        icon = QIcon(icon_path)
        MainWindow.setWindowIcon(icon)
    except Exception as e:
        print(f"Error loading icon: {e}")
        print('CHalf Protein Logo.png might be missing from /images or path is incorrect.')
